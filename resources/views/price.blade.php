        ...
        <div class="mt-24 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
                ...
                <div class="flex-1">
                    ...
                    <ul role="list" class="mt-6 space-y-6">
                        <li class="flex">
                            ...
                            <span class="ml-3 text-gray-500">1 document</span>
                        </li>
                        ...
                        <li class="flex">
                            ...
                            <span class="ml-3 text-gray-500">10 questions</span>
                        </li>
            ...
            <div class="relative flex flex-col rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
                ...
                @if (
                    !auth()->user()
                        ?->subscribed())
                    <a href="{{ route('pay', ['plan' => 'monthly']) }}" class="bg-indigo-500 text-white hover:bg-indigo-600 mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium">Monthly billing</a>
                @endif
            </div>
            ...
            <div class="relative flex flex-col rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
                ...
                @if (
                    !auth()->user()
                        ?->subscribed())
                    <a href="{{ route('pay', ['plan' => 'yearly']) }}"class="bg-indigo-50 text-indigo-700 hover:bg-indigo-100 mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium">Annually billing</a>
                @endif
            </div>
        </div>
    </div>
