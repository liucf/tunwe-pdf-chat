<div>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <x-action-message class="" on="fileuploaded">
            ...
            @else
                <div>
                    <livewire:pages.documents.upload-document-form-to-list @fileuploadedlist="$refresh" />

                    <livewire:pages.documents.list :$documents />
                </div>
        </div>
        @endif
